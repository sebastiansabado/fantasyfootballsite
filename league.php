            ...
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <h2 class="intro-text text-center">
                      ...
                      <div class="dropdown" id="league-name-dropdown">
                        <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Select League Name<span class="caret"></span></button>
                      </div>
                    <hr>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <p>League information shit and details and shit </p>
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                  ...
                  <div class="dropdown" id="league-year-dropdown">
                        <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Select Year<span class="caret"></span></button>
                      </div>
                    <hr>
                </div>
        <!--*****************php loop foreach league member*******************-->
